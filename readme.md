...
## Note:
Inference speed will depend upon CPU cores and available RAM. It's recomended to have multi core CPU (Laptop / PC) with atleast 16GB RAM. You can deploy it on Server for better performance.
